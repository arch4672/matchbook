...
class TestMatchbook(TestCase):
    api = APIClient(
        username=os.environ["MATCHBOOK_USERNAME"], password=os.environ["MATCHBOOK_PW"]
    )
    api.login()
    ...
    def test_get_prices(self):
        ...
        market_id = next(
            mkt["id"]
            for mkt in top_event["markets"]
            if mkt["market-type"] == "money_line"
        )
    ...
    def test_send_quotes(self):
        order_list = [
            {
                "market_id": "450147584000010",
                "order_type": "GFD",
                "timestamp": 1491008502,
                "credit": 0,
                "channel_type": "matchbook",
                "side": "back",
                "size": 55.0,
                "runner_id": 450147584080010,
                "runner": "Utah Jazz",
                "price": 1.81,
            },
            {
            ...
            },
            {
                ...
                "side": "back",
                "size": 40.0,
                "runner_id": 450147584030010,
                "runner": "Washington Wizards",
                "price": 2.48,
            },
            {
                "market_id": "450147584000010",
        ...
        orders_transposed = dict(
            zip(order_list[0], zip(*[d.values() for d in order_list]))
        )
