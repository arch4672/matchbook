...
class BetReport(BaseResource):
    class Meta(BaseResource.Meta):
        ...
        datetime_attributes = "submitted-at"
...
class SettlementSelection(BaseResource):
    class Meta(BaseResource.Meta):
        ...
        sub_resources = {"bets": SettlementBet}
...
class SettlementMarket(BaseResource):
    class Meta(BaseResource.Meta):
        ...
        sub_resources = {"selections": SettlementSelection}
...
class SettlementEvent(BaseResource):
    class Meta(BaseResource.Meta):
        ...
        sub_resources = {"markets": SettlementMarket}
...
class SettlementReport(BaseResource):
    class Meta(BaseResource.Meta):
        ...
        sub_resources = {"events": SettlementEvent}
        datetime_attributes = "settled-at"
...
class RunnerSettlementReport(BaseResource):
    class Meta(BaseResource.Meta):
        ...
        datetime_attributes = ("settled-at", "placed-at")
...
class TransactionReport(BaseResource):
    class Meta(BaseResource.Meta):
        ...
        datetime_attributes = "time-settled"
